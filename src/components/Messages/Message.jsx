        ...
        <>
            <div className='w-full inline-block min-h-[70vh]  flex flex-col justify-between gap-[2rem]'>
                ...
                <div className='h-full w-full  flex items-center'>
                    {messages.length === 0 ? <div className='w-full  text-[2rem] text-[#CCCCCC] font-[700]  flex items-center justify-center'>No Messages yet</div> :
                        <MessageArea>
                ...
                <div className='w-full flex items-center justify-center '>
                    <InputBar
                        className="h-[2.5rem] w-[70%] flex items-center justify-center"
                        type="chat"
                        value={value}
