...
const ProviderDetails = () => {
    ...
    return (
        <>
            ...
            {providerDetailLoading ? <div className='min-h-[78vh] w-full bg-[white] p-[1rem]  flex gap-[1rem] justify-center items-center  mt-4   border border-[#c4c4c4]  rounded-[9px]  shadow-lg'>
                <Loader />
            </div> :
                <>
                    <div className='min-h-[78vh] w-full bg-[white] p-[1rem]  flex gap-[1rem] flex-col  mt-4   border border-[#c4c4c4]  rounded-[9px]  shadow-lg'>
                        <div className='w-full flex '>
                            ...
                            <div className='flex w-[60%] items-center   gap-[4rem] justify-center'>
                                ...
                                <ExperiencePanel
                                    img={Profile}
                                    type="experience"
                                    numberOfType={`${getProviderData?.experience || "0"} ${'years'}`}
                                />
                                <ExperiencePanel
                                    img={Profile}
                                    type="rating"
                        ...
                        <div className='w-[90%] h-full mt-[2rem]'>
                            <div className='w-full'>
                                ...
                                <div className='text-[0.93rem] font-[400] '>{getProviderData && getProviderData.about}</div>
                            </div>
                            <div className='w-full mt-[2rem]'>
                                <div className='text-[1.2rem] font-primary font-[600] mb-[0.5rem]'>Working Time</div>
                                <div className='text-[0.93rem] font-[400] '>Starting Time: {getProviderData.workingTimes?.start || <span className='font-[500] text-[#808080]'>Loading</span>}</div>
                                <div className='text-[0.93rem] font-[400] '>Ending Time: {getProviderData.workingTimes?.end || <span className='font-[500] text-[#808080]'>Loading</span>}</div>
                            </div>
                            <div className=' w-full flex  mt-[2rem]'>
                                <div className='w-[50%] '>
                                    ...
                                    {getProviderData === true ?
                                        (getProviderData.reviews.length < 1 ? "No reviews yet" : <ReviewDetail />) :
                                        (<div className='font-[500] text-[#808080]'>No reviews yet</div>)
                                    }
